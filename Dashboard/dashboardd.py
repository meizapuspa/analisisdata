...
# Menampilkan logo
st.image('Data/logo.png', width=150)  # Update logo path relative to the script

# Membaca dataset
customers_df = pd.read_csv('Data/customers_dataset.csv')  # Updated path
orders_df = pd.read_csv('Data/orders_dataset.csv')  # Updated path
order_items = pd.read_csv('Data/order_items_dataset.csv')  # Updated path
order_pay = pd.read_csv('Data/order_payments_dataset.csv')  # Updated path
