...
# Membaca dataset
customers_df = pd.read_csv('C:\\Users\\meiza\\ecommerce_data\\customers_dataset.csv')
orders_df = pd.read_csv('C:\\Users\\meiza\\ecommerce_data\\orders_dataset.csv')
order_items = pd.read_csv('C:\\Users\\meiza\\ecommerce_data\\order_items_dataset.csv')
order_pay = pd.read_csv('C:\\Users\\meiza\\ecommerce_data\\order_payments_dataset.csv')
